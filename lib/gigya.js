...
// performance improvement: increase max number of sockets
var separateReqPool = { maxSockets: 100 };
var request = requestBase.defaults({ pool: separateReqPool});
  ...
  var apiCall = function(endpoint, params, callback, retries, emitter) {
    ...
    var handleResponse = function(response) {
      ...
      if(json.errorCode != 0) {
        ...
        // include original gigya response data in error.
        // fe: To follow-up on login errors we need the regToken
        for (var attr in json) {e[attr] = json[attr]; }
